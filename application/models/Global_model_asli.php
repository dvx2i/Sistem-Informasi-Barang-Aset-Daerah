...
class Global_model extends CI_Model
{
  ...
  public function get_request_validasi_a()
  {
	...
	if($session->id_role =='1'){
		...
		$where_lokasi = " and CONVERT(C.pengguna,signed) = '".$pengguna."'";
		$groupby = ''; 
	}
  ...
  public function set_validasi($kode_jenis = null, $id_kib = null)
  {
    // die(" call validasi ('" . $kode_jenis . "','" . $id_kib . "') ");
    $this->db_1 = $this->load->database('default', true);
    $query    = $this->db_1->query(" call validasi ('" . $kode_jenis . "','" . $id_kib . "') ");
    $res      = $query->result();
  ...
  public function set_validasi_atb($kode_jenis = null, $id_kib = null)
  {
    // die($kode_jenis . "','" . $id_kib);
    $query    = $this->db->query("call validasi_atb ('" . $kode_jenis . "','" . $id_kib . "')");
    $res      = $query->result();
