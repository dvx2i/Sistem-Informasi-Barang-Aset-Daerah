...
class Global_model extends CI_Model
{
  ...
  function update_histori_barang($kode_gol,$id_kib, $data)
  {
  ...
  function update_histori_barang_atb($kode_gol,$id_kib, $data)
  {
    $this->db->where('id_kib', $id_kib);
    $this->db->where('kode_jenis', $kode_gol);
  ...
  function get_lokasi_all_by_pengguna($id_pengguna = null)
  {
    $this->db->where('pengguna <>', '010201');
    $this->db->where('pengguna <>', '010101');
    $this->db->where('kuasa_pengguna <>', '*');
    return $this->db->get($this->tbl_lokasi)->result();
  }
