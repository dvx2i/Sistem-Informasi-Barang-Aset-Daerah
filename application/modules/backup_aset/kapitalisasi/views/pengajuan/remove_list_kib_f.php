...
$(document).ready(function() {
  ...
  var t = $("#mytable_kib_f").dataTable({
    initComplete: function() {
      ...
      $('#mytable_kib_f').on('click','.pengajuan', function(e){
    ...
    processing: true,
    serverSide: true,
    ajax: {"url": base_url+"penghapusan/global_penghapusan/json_kib_f/list_barang", "type": "POST"},
    columns: [
    {
      "data": "id_kib_f",
      "orderable": false
  ...
  $('#temp_kib_f').on('click','.pengajuan', function(e){
