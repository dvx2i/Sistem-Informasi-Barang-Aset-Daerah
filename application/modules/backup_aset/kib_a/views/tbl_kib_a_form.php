...
<section class="content">
  ...
  <form action="<?php echo $action; ?>" method="post" autocomplete="off">
    ...
    <div <?= $id_kib_a == '' ? ' id="input_disable" class="input_disable" ' : ''; ?>>
      ...
      <div class="box" style="padding: 10px; border: 3px solid #d2d6de;">
        ...
        <div id='input_disable_barang' class="<?php echo (($validasi == 2) or (!empty($data_reklas))) ? "input_disable" : ""; ?>">
          <div class="row">
            <div class="col-md-6">
              <a style="margin-bottom: 5px;" class="btn btn-success btn-sm" href="https://aset.jogjakota.go.id/assets/files/TANAH.pdf" target="_blank">Referensi Kode Barang</a>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control tahun_input" name="tahun_pengadaan" id="tahun_pengadaan" placeholder="Tahun Pengadaan" value="<?php echo $tahun_pengadaan; ?>" />
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control date_input" name="sertifikat_tanggal" id="sertifikat_tanggal" placeholder="Tanggal Sertifikat"  value="<?php echo $sertifikat_tanggal; ?>" />
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="sertifikat_nomor" id="sertifikat_nomor" placeholder="Nomor Sertifikat" value="<?php echo $sertifikat_nomor; ?>" />
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <?php if (empty($data_reklas)) : ?>
        <a href="<?php echo base_url('kib_a') ?>" class="btn btn-default">Batalkan</a>
      <?php else : ?>
