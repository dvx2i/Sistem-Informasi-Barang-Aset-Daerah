    ...
    class Kib extends CI_Controller
    {
      ...
      public function excel()
      {
        ...
        if ($data['kode_jenis'] == '01') {
          ...
          $data['label'] = array('No',  'Kode Barang',  'Nomor Register',  'Nama Barang / Uraian',  'Merk / Type', 'Sertifikat Nomor', 'Bahan', 'Asal/Cara Perolehan Barang', 'Tahun Perolehan', 'Ukuran Barang / konstruksi (P,S,D)', 'Satuan', 'Keadaan Barang(B,RR,RB)', 'Jumlah Barang', 'Harga', 'Keterangan');
          if($data['id_kuasa_pengguna'] == ''){
            array_push($data['field_name'], 'instansi');
          }
        }
