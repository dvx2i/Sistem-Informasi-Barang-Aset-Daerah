...
*/
  ...
  public function toExcel($data = null)
  {
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('D' . $counter, 'REALISASI BELANJA');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E' . $counter, 'REALISASI SIMBADA');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F' . $counter, 'SELISIH');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G' . $counter, 'KETERANGAN');

    $objPHPExcel->getActiveSheet()->getStyle("A" . $first_row_header . ":G7")
      ->applyFromArray($table_header)
      ->getFont()->setSize(12);
      $objPHPExcel->getActiveSheet()->getStyle("A7:G7")
    ...
    foreach ($data['mutasi'] as $key => $value1) :
      $counter = $counter + 1;
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('D' . $counter, '');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E' . $counter, $value1['realisasi']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F' . $counter, '=(D'.$counter.'-E'.$counter.')');
