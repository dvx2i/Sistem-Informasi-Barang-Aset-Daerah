...
class Rekap_mutasi_kib extends MX_Controller
{
  ...
  public function index()
  {
    ...
    $data['content'] = $this->load->view('/rekap_mutasi_kib/home', $data, true);
...
*/
  ...
  public function toExcel($data = null)
  {
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H' . $counter, 'PENGURANGAN');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L' . $counter, 'SALDO AKHIR');
    ...
    $objPHPExcel->getActiveSheet()->mergeCells('H' . $counter . ':K' . $counter);
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E' . $counter, 'PENAMBAHAN NILAI');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F' . $counter, 'MUTASI MASUK');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G' . $counter, 'REKLASIFIKASI');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H' . $counter, 'PENGHAPUSAN');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I' . $counter, 'PENGURANGAN NILAI');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J' . $counter, 'MUTASI KELUAR');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K' . $counter, 'REKLASIFIKASI');
    ...
    $objPHPExcel->getActiveSheet()->getStyle("A" . $first_row_header . ":L" . $last_row_header)
      ->applyFromArray($table_header)
      ->getFont()->setSize(12);
      $objPHPExcel->getActiveSheet()->getStyle("A8:L9")
    ...
    foreach ($data['mutasi'] as $key => $value1) :
      ...
      $counter = $counter + 1;
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F' . $counter, $value1['mutasi_in']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G' . $counter, $value1['reklas_plus']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H' . $counter, $value1['penghapusan']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I' . $counter, $value1['koreksi_kurang']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J' . $counter, $value1['mutasi_out']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K' . $counter, $value1['reklas_min']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L' . $counter, $value1['saldo_akhir']);
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('C' . $counter, '=SUM(C10:C'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('D' . $counter, '=SUM(D10:D'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E' . $counter, '=SUM(E10:E'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F' . $counter, '=SUM(F10:F'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G' . $counter, '=SUM(G10:G'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H' . $counter, '=SUM(H10:H'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I' . $counter, '=SUM(I10:I'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J' . $counter, '=SUM(J10:J'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K' . $counter, '=SUM(K10:K'.$last.')');
