...
class Mutasi_model extends CI_Model
{
  ...
  function get_all($data)
  {
    ...
    $query    = $this->db->query("call proc_laporan_mutasi(" . $data['session']->id_user . "," . $data['id_pemilik'] . "," . $data['id_kode_lokasi'] . ",'" . $data['start_bulan'] . "','" . $data['start_tahun'] . "','" . $data['last_bulan'] . "','" . $data['last_tahun'] . "', '" . $data['intra_ekstra'] . "')");
