...
<section class="content">
  <h2 style="margin-top:0px">Laporan Rekap Mutasi KIB</h2>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="<?= base_url('laporan/rekap_mutasi_kib/ndownload'); ?>" method="post" target="_blank">
