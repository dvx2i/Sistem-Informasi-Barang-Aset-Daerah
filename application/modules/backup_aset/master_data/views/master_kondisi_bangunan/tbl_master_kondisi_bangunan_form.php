  ...
  <section class="content">
    <h2 style="margin-top:0px">Kondisi Bangunan <?php echo $button ?></h2>
    <form action="<?php echo $action; ?>" method="post">
      ...
      <input type="hidden" name="id_master_kondisi_bangunan" value="<?php echo $id_master_kondisi_bangunan; ?>" />
