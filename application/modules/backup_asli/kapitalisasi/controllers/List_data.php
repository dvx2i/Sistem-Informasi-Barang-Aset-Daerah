  ...
  public function delete($id)
  {
    ...
    if ($row) {
      ...
      if ($locked < 1) {
        ...
        if ($row->jenis == 'koreksi_kurang') {
          $status_histori = 'koreksi_kurang';
        } else {
          $status_histori = 'koreksi_tambah';
        }

        $this->global_model->delete_histori_barang($kode_jenis, $id_kib,$row->tanggal_pengajuan, $status_histori);
