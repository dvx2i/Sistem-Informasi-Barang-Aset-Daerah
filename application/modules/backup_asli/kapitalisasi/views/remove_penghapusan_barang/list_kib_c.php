...
$(document).ready(function() {
  ...
  var t = $("#mytable_kib_c").dataTable({
    initComplete: function() {
      ...
      $('#mytable_kib_c').on('click','.penghapusan', function(e){
        ...
        var arr_kib_c={};
        var temp = JSON.parse(sessionStorage.getItem("penghapusan_kib_c"));
        ...
        sessionStorage.setItem("penghapusan_kib_c", JSON.stringify(arr_kib_c));
        draw_penghapusan_c();
      });
    ...
    processing: true,
    serverSide: true,
    ajax: {"url": base_url+"penghapusan/global_penghapusan/json_kib_c/penghapusan_barang", "type": "POST"},
    columns: [
    {
      "data": "id_kib_c",
      "orderable": false
    },{"data": "kode_barang",},{"data": "nama_barang",'width':'15%',},{"data": "nomor_register"},{"data": "kondisi_bangunan"},{"data": "bangunan_bertingkat"},{"data": "bangunan_beton"},{"data": "luas_lantai_m2",'width':'7%',},{"data": "lokasi_alamat",'width':'10%',},{"data": "gedung_tanggal",'width':'10%',},{"data": "gedung_nomor"},{"data": "luas_m2"},{"data": "status",'width':'15%',},{"data": "nomor_kode_tanah",'width':'7%',},{"data": "asal_usul"},{"data": "harga"},{"data": "keterangan"},
    {
      "data" : null,
      "orderable": false,
  ...
  $('#temp_kib_c').on('click','.penghapusan', function(e){
    var attr_id = $(this).attr('attr_id');
    var arr_temp=JSON.parse(sessionStorage.getItem("penghapusan_kib_c"));
    delete arr_temp[attr_id];
    sessionStorage.setItem("penghapusan_kib_c", JSON.stringify(arr_temp));
    draw_penghapusan_c()
  })
  ...
  function draw_penghapusan_c(){
    ...
    $.each(arr_temp, function( index, data ) {
      ...
      var input_penghapusan = '<input class="'+_id+' hapus_temp_kib_c" type="hidden" name="penghapusan['+id_penghapusan+'][]" value="'+id_penghapusan_barang+'">';
      var tr =
