<section class="content">
  ...
  <table style="vertical-align: middle;" class="table table-bordered table-striped" id="mytable">
    <thead>
      <tr>
        <th width="10px"></th>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var t = $("#mytable").dataTable({
      ...
      serverSide: true,
      ajax: {
        "url": base_url + "kib_b/validasi/json/" + $('#kode_lokasi').val(),
        "type": "POST",
        /*"data": function ( data ) {
    ...
    // console.log('hal');
    // $('.checkbox_kib').prop('checked',true);
