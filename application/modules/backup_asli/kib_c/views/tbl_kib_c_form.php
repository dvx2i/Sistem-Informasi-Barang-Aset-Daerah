...
<section class="content">
  ...
  <form action="<?php echo $action; ?>" method="post" autocomplete="off" >
    ...
    <div <?= $id_kib_c == '' ? ' id="input_disable" class="input_disable" ' : ''; ?>>
      ...
      <div class="box" style="padding: 10px; border: 3px solid #d2d6de;">
        ...
        */ ?>
        ...
        <div id='input_disable_barang' class="<?php echo (($validasi == 2) or (!empty($data_reklas))) ? "input_disable" : ""; ?>">
          <div class="row">
            <div class="col-md-6">
              <a style="margin-bottom: 5px;" class="btn btn-success btn-sm" href="https://aset.jogjakota.go.id/assets/files/GEDUNG_DAN_BANGUNAN.pdf" target="_blank">Referensi Kode Barang</a>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <select class="form-control " name="kondisi_bangunan" id="kondisi_bangunan" data-role="select2">
              <option value="">Silahkan Pilih</option>
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <select class="form-control" name="bangunan_bertingkat" id="bangunan_bertingkat">
              <option value="">Silahkan Pilih</option>
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <select class="form-control" name="bangunan_beton" id="bangunan_beton">
              <option value="">Silahkan Pilih</option>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control format_number" name="luas_lantai_m2" id="luas_lantai_m2" placeholder="Luas Lantai (M2)" value="<?php echo $luas_lantai_m2; ?>" />
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" rows="3" name="lokasi_alamat" id="lokasi_alamat" placeholder="Lokasi Alamat"><?php echo $lokasi_alamat; ?></textarea>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label for="date">Tanggal Dokumen Gedung (SPK/IMB/Kontrak)<?php echo form_error('gedung_tanggal') ?></label>
            <input type="text" class="form-control date_input" name="gedung_tanggal" id="tahun_pengadaan" placeholder="Tanggal Dokumen Gedung" value="<?php echo $gedung_tanggal; ?>" />
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="gedung_nomor" id="gedung_nomor" placeholder="Gedung Nomor" value="<?php echo $gedung_nomor; ?>" />
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="nomor_kode_tanah" id="nomor_kode_tanah" placeholder="Nomor Kode Tanah" value="<?php echo $nomor_kode_tanah; ?>" />
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-control " name="status" id="status" data-role="select2">
                <option value="">Silahkan Pilih</option>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="latitute" id="latitute" placeholder="Misal: -7.78278" value="<?php echo $latitute; ?>" />
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="varchar">Longitute <?php echo form_error('longitute') ?></label>
            <input type="text" class="form-control" name="longitute" id="longitute" placeholder="Misal: 110.36083" value="<?php echo $longitute; ?>" />
          </div>
        </div>
      </div>
      ...
      <?php if (empty($data_reklas)) : ?>
        <a href="<?php echo base_url('kib_c') ?>" class="btn btn-default">Batalkan</a>
      <?php else : ?>
