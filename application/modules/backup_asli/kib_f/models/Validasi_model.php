...
class Validasi_model extends CI_Model
{
  ...
  function json($id_kode_lokasi)
  {
    ...
    $this->datatables->select('id_kib_f,tanggal_transaksi,kode_barang,nama_barang,bangunan,kontruksi_bertingkat,kontruksi_beton,luas_m2,lokasi_alamat,dokumen_tanggal,dokumen_nomor,tanggal_mulai,status_tanah,nomor_kode_tanah,asal_usul,nilai_kontrak,A.keterangan,A.kode_lokasi,validasi, reject_note, B.instansi');
