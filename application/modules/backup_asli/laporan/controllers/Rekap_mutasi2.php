...
class Rekap_mutasi2 extends CI_Controller
{
  function __construct()
  {
    ...
    $this->load->model('rekap_mutasi2_model');
  ...
  public function index()
  {
    ...
    $data['content'] = $this->load->view('rekap_mutasi2/home', $data, true);
  ...
  public function ndownload()
  {
    ...
    $data['rekap_mutasi'] = $this->rekap_mutasi2_model->get_all($data);
    // print_r($data['rekap_mutasi']); die;
    if ($data['format'] == 'pdf')
      $this->toPdf($data);
  ...
  public function toPdf($data = null)
  {
    ...
    $html = $this->load->view('rekap_mutasi2/report_pdf', $data, true);
    $this->pdfgenerator->generate($html, 'Laporan Mutasi', true, 'folio', 'landscape');
    // $this->load->view('rekap_mutasi2/report_pdf', $data);
  }
...
*/
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue("D" . $counter, "Jumlah (Awal) Bulan ".bulan_indo(1));
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue("F" . $counter, "MUTASI/PERUBAHAN");
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue("J" . $counter, "Jumlah (Akhir) Bulan ".bulan_indo($data['bulan']));
