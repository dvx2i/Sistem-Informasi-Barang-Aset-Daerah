...
<section class="content">
  <h2 style="margin-top:0px">Laporan Rekap Inventaris</h2>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" id="form-laporan" action="<?= base_url('laporan/rekap_inventaris/excel'); ?>" method="post" target="_blank">
            ...
            */ ?>
            ...
            <div class="form-group form-inline">
              ...
              <div class="col-sm-10">
                ...
                - */
                ?>
                <input type="hidden" name="start_bulan" id="start_bulan" value="">
                <!-- <div class="input-group m-t-3">
                  <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                  <input id="last_date" type="text" class="form-control pull-right date_input" name="last_date" placeholder="Tanggal Selesai" value="<?= $this->input->get('last_date'); ?>">
                </div> -->
                <div class="input-group m-t-3">
                  ...
                  <div class="input-group">
                    <select name="last_bulan" id="last_bulan" class="form-control pull-right ">
                      <?php
                      $bulan = array("Saldo Awal", "Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember");
                      for ($a = 0; $a <= 12; $a++) {
                        if ($a == date("m")) {
                          $pilih = "selected";
                        } else {
