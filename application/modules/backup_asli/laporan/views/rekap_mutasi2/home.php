...
<section class="content">
  <h2 style="margin-top:0px">Laporan Rekap Mutasi Cutoff</h2>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" id="form-laporan" action="<?= base_url('laporan/rekap_mutasi2/ndownload'); ?>" method="post" target="_blank">
          ...
          <div class="box-body">
            ...
            */ ?>
            ...
            <div class="form-group form-inline">
              <label for="" class="col-sm-2 control-label">Tanggal Cutoff </label>
              <div class="col-sm-10">
                ...
                <div class="input-group m-t-3">
                  ...
                  <div class="input-group">
                    <select name="bulan" id="last_bulan" class="form-control pull-right ">
                      <?php
                  ...
                  <div class="input-group">
                    ...
                    <select name="tahun" class="form-control pull-right " id="last_tahun">
                      <?php
