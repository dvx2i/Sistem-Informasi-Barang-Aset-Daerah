<table class="table table-bordered table-striped" style="display: none;" id="mytable_kib_e">
  <thead>
    <tr>
      <th width="80px">No</th>
      <th width="10%">Aksi</th>
  ...
  $(document).ready(function() {
    ...
    var t = $("#mytable_kib_e").dataTable({
      initComplete: function() {
        ...
        $('#mytable_kib_e').on('click', '.lampiran', function(e) {
      ...
      "info": false,
      ajax: {
        "url": base_url + "penghapusan/global_penghapusan/json_kib_e/laporan",
        "type": "POST",
        "data": function(data) {
    ...
    $('#temp_kib_e').on('click', '.lampiran', function(e) {
    ...
    function draw_lampiran_e() {
      ...
      $.each(arr_temp, function(index, data) {
        ...
        var input_lampiran = '<input class="' + _id + ' hapus_temp_kib_e" type="hidden" name="lampiran[' + id_penghapusan + '][]" value="' + id_penghapusan_barang + '">';
        var tr =
