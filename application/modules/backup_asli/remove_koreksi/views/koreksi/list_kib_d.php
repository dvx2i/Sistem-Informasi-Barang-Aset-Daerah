...
$(document).ready(function() {
  ...
  var t = $("#mytable_kib_d").dataTable({
    initComplete: function() {
      ...
      $('#mytable_kib_d').on('click','.koreksi', function(e){
    ...
    processing: true,
    serverSide: true,
    ajax: {"url": base_url+"penghapusan/global_penghapusan/json_kib_d/list_barang", "type": "POST"},
    columns: [
    {
      "data": "id_kib_d",
      "orderable": false
  ...
  $('#temp_kib_d').on('click','.koreksi', function(e){
