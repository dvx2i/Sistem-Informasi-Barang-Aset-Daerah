  ...
  $(document).ready(function() {
    ...
    var t = $("#mytable_kib_c").dataTable({
      initComplete: function() {
        ...
        $('#mytable_kib_c').on('click', '.pengajuan', function(e) {
      ...
      serverSide: true,
      ajax: {
        "url": base_url + "kapitalisasi/global_kapitalisasi/json_kib_c/list_barang",
        "type": "POST"
      },
      columns: [{
          "data": "id_kib_c",
    ...
    $('#temp_kib_c').on('click', '.pengajuan', function(e) {
