...
$(document).ready(function() {
  ...
  var t = $("#mytable_kib_f").dataTable({
    initComplete: function() {
      ...
      $('#mytable_kib_f').on('click','.penghapusan', function(e){
        ...
        var arr_kib_f={};
        var temp = JSON.parse(sessionStorage.getItem("penghapusan_kib_f"));
        ...
        sessionStorage.setItem("penghapusan_kib_f", JSON.stringify(arr_kib_f));
        draw_penghapusan_f();
      });
    ...
    processing: true,
    serverSide: true,
    ajax: {"url": base_url+"penghapusan/global_penghapusan/json_kib_f/penghapusan_barang", "type": "POST"},
    columns: [
    {
      "data": "id_kib_f",
      "orderable": false
    },{"data": "kode_barang",'width':'5%'},{"data": "nama_barang",'width':'20%'},
    {"data": "bangunan"},{"data": "kontruksi_bertingkat"},{"data": "kontruksi_beton"},
    {"data": "luas_m2"},{"data": "lokasi_alamat"},{"data": "dokumen_tanggal",'width':'10%'},
    {"data": "dokumen_nomor"},{"data": "tanggal_mulai",'width':'10%'},
    {"data": "status_tanah",'width':'20%'},{"data": "nomor_kode_tanah",'width':'10%'},
    {"data": "asal_usul"},{"data": "nilai_kontrak"},{"data": "keterangan"},
    // {"data": "kode_lokasi"},
    {
      "data" : null,
      "orderable": false,
  ...
  $('#temp_kib_f').on('click','.penghapusan', function(e){
    var attr_id = $(this).attr('attr_id');
    var arr_temp=JSON.parse(sessionStorage.getItem("penghapusan_kib_f"));
    delete arr_temp[attr_id];
    sessionStorage.setItem("penghapusan_kib_f", JSON.stringify(arr_temp));
    draw_penghapusan_f()
  })

  function draw_penghapusan_f(){
    var arr_temp=JSON.parse(sessionStorage.getItem("penghapusan_kib_f"));
    var no=0;
    ...
    $.each(arr_temp, function( index, data ) {
      ...
      var input_penghapusan = '<input class="'+_id+' hapus_temp_kib_f" type="hidden" name="penghapusan['+id_penghapusan+'][]" value="'+id_penghapusan_barang+'">';
      var tr =
