...
class Penghapusan extends MX_Controller
{
  function __construct()
  {
    ...
    $this->load->model('penghapusan/laporan_model');
    $this->load->model('penghapusan/pengecekan_barang_model');
  ...
  public function detail($id_pengahapusan_lampiran)
  {
    ...
    $data['content'] = $this->load->view('penghapusan/detail', $data, true);
    $data['breadcrumb'] = array(
      array('label' => 'Penghapusan', 'url' => '#', 'icon' => 'fa fa-pie-chart', 'li_class' => ''),
  ...
  public function create($id_penghapusan = null)
  {
    ...
    $data['content'] = $this->load->view('penghapusan/form', $data, true);
    $data['breadcrumb'] = array(
      array('label' => 'Penghapusan', 'url' => '#', 'icon' => 'fa fa-pie-chart', 'li_class' => ''),
      array('label' => 'Lampiran', 'url' => '#', 'icon' => '', 'li_class' => ''),
  ...
  public function laporan_detail($id_pengahapusan_lampiran)
  {
    ...
    $lampiran = $this->laporan_model->get_lampiran($id_pengahapusan_lampiran, $lastPenyusutan);
