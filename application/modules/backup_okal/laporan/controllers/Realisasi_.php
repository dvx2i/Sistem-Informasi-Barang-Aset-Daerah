  ...
  public function ndownload()
  {
    ...
    if($data['jenis'] == 'bulan'){
      ...
      if($this->input->post('semester') == '1'){
        ...
        $data['start_date'] = date('Y-m-d', $data['tahun'].'-01-01');
        $data['last_date'] = date('Y-m-d', $data['tahun'].'-06-31');
      }else{
        $data['start_bulan'] = '7';
        $data['start_tahun'] = date('Y');
        $data['last_bulan'] = '12';
        $data['last_tahun'] = date('Y');
        $data['start_date'] = date('Y-m-d', $data['tahun'].'-07-01');
        $data['last_date'] = date('Y-m-d', $data['tahun'].'-12-31');
      }
