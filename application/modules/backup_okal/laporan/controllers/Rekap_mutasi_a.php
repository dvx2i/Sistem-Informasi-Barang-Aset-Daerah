...
class Rekap_mutasi_a extends MX_Controller
{
  function __construct()
  {
    parent::__construct();
    $this->global_model->cek_hak_akses('47');
  ...
  public function index()
  {
    ...
    $data['breadcrumb'] = array(
      ...
      array('label' => 'Rekap Mutasi Tanah', 'url' => '#', 'icon' => '', 'li_class' => 'active'),
      // array('label' => 'Buat', 'url' => '#','icon'=>'', 'li_class'=>'active'),
    );
    $data['url'] = base_url('laporan/rekap_mutasi_a/ndownload');
...
*/
  ...
  public function toExcel($data = null)
  {
    ...
    $objPHPExcel->getActiveSheet()->setTitle('REKAP MUTASI '.strtoupper($data['jenis']['nama']));
