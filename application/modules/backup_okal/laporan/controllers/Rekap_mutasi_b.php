...
class Rekap_mutasi_b extends MX_Controller
{
  function __construct()
  {
    parent::__construct();
    $this->global_model->cek_hak_akses('48');
  ...
  public function index()
  {
    ...
    $data['breadcrumb'] = array(
      ...
      array('label' => 'Rekap Mutasi Peralatan dan Mesin', 'url' => '#', 'icon' => '', 'li_class' => 'active'),
      // array('label' => 'Buat', 'url' => '#','icon'=>'', 'li_class'=>'active'),
    );
    $data['url'] = base_url('laporan/rekap_mutasi_b/ndownload');
...
*/
  ...
  public function toExcel($data = null)
  {
    ...
    header('Content-Disposition: attachment;filename="Export REKAP MUTASI '.strtoupper($data['jenis']['nama'])  . date('Y-m-d') . '.xlsx"');
  ...
  public function toExcelRekon($data = null)
  {
    ...
    // $mutasi = $this->rekap_mutasi_aset_model->get_all($data);
