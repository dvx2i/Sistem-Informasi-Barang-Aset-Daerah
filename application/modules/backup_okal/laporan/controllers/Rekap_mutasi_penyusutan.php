...
class Rekap_mutasi_penyusutan extends MX_Controller
{
  function __construct()
  {
    ...
    $this->load->model('rekap_mutasi_penyusutan_model');
  ...
  public function index()
  {
    ...
    $data['content'] = $this->load->view('/rekap_mutasi_penyusutan/home', $data, true);
  ...
  public function ndownload()
  {
    ...
    $data['last_bulan'] = date('m', tgl_inter("1 " . $this->input->post('last_bulan_tahun')));
...
*/
    ...
    $data['mutasi'] = $this->rekap_mutasi_penyusutan_model->get_all($data);
  ...
  public function toExcel($data = null)
  {
    ...
    // $mutasi = $this->rekap_mutasi_penyusutan_model->get_all($data);
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('V' . $counter, '=SUM(V11:V'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('W' . $counter, '=SUM(W11:W'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('X' . $counter, '=SUM(X11:X'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y' . $counter, '=SUM(Y11:Y'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z' . $counter, '=SUM(Z11:Z'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA' . $counter, '=SUM(AA11:AA'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AB' . $counter, '=SUM(AB11:AB'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AC' . $counter, '=SUM(AC11:AC'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AD' . $counter, '=SUM(AD11:AD'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AE' . $counter, '=SUM(AE11:AE'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AF' . $counter, '=SUM(AF11:AF'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AG' . $counter, '=SUM(AG11:AG'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AH' . $counter, '=SUM(AH11:AH'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AI' . $counter, '=SUM(AI11:AI'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AJ' . $counter, '=SUM(AJ11:AJ'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AK' . $counter, '=SUM(AK11:AK'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AL' . $counter, '=SUM(AL11:AL'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AM' . $counter, '=SUM(AM11:AM'.$last.')');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AN' . $counter, '=SUM(AN11:AN'.$last.')');
