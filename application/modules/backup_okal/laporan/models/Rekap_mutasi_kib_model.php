...
class Rekap_mutasi_kib_model extends CI_Model
{
  ...
  if(substr($date,9,2) == '01'){
    ...
    if($data['kode_kelompok'] != '5'){ // jika aset tetap)
      ...
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN(a.id_rekening = '1754' OR (SUBSTR(r.kode_rekening, 5, 2) <> '01' AND SUBSTR(r.kode_rekening, 5, 2) <> '02' AND SUBSTR(r.kode_rekening, 5, 2) <> '03' AND SUBSTR(r.kode_rekening, 5, 2) <> '04' AND SUBSTR(r.kode_rekening, 5, 2) <> '05') ) AND status_histori = 'entri' AND harga >= d.value THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN (a.id_rekening = '1754' OR (SUBSTR(r.kode_rekening, 5, 2) <> '01' AND SUBSTR(r.kode_rekening, 5, 2) <> '02' AND SUBSTR(r.kode_rekening, 5, 2) <> '03' AND SUBSTR(r.kode_rekening, 5, 2) <> '04' AND SUBSTR(r.kode_rekening, 5, 2) <> '05') )  AND status_histori = 'entri' AND harga < d.value THEN harga ELSE 0 END) 
      END AS entri_lain_2,
      ...
      END AS entri_tt,
      CASE WHEN '".$data['intra_ekstra']."' = '00' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.01' AND status_histori = 'entri' THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.01' AND status_histori = 'entri' AND harga >= d.value THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.01' AND status_histori = 'entri' AND harga < d.value THEN harga ELSE 0 END)  
      END AS entri_bm_a,
      CASE WHEN '".$data['intra_ekstra']."' = '00' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.02' AND status_histori = 'entri' THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.02' AND status_histori = 'entri' AND harga >= d.value THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.02' AND status_histori = 'entri' AND harga < d.value THEN harga ELSE 0 END)  
      END AS entri_bm_b,
      CASE WHEN '".$data['intra_ekstra']."' = '00' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.03' AND status_histori = 'entri' THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.03' AND status_histori = 'entri' AND harga >= d.value THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.03' AND status_histori = 'entri' AND harga < d.value THEN harga ELSE 0 END)  
      END AS entri_bm_c,
      CASE WHEN '".$data['intra_ekstra']."' = '00' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.04' AND status_histori = 'entri' THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.04' AND status_histori = 'entri' AND harga >= d.value THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.04' AND status_histori = 'entri' AND harga < d.value THEN harga ELSE 0 END)  
      END AS entri_bm_d,
      CASE WHEN '".$data['intra_ekstra']."' = '00' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.05' AND status_histori = 'entri' THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.05' AND status_histori = 'entri' AND harga >= d.value THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.05' AND status_histori = 'entri' AND harga < d.value THEN harga ELSE 0 END)  
      END AS entri_bm_e,
      ...
      END AS entri_barjas,
      CASE WHEN '".$data['intra_ekstra']."' = '00' THEN SUM(CASE WHEN (a.id_rekening = '1754' OR (SUBSTR(r.kode_rekening, 5, 2) <> '01' AND SUBSTR(r.kode_rekening, 5, 2) <> '02' AND SUBSTR(r.kode_rekening, 5, 2) <> '03' AND SUBSTR(r.kode_rekening, 5, 2) <> '04' AND SUBSTR(r.kode_rekening, 5, 2) <> '05') ) AND status_histori IN ('koreksi_tambah','kapitalisasi') THEN harga ELSE 0 END) 
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN (a.id_rekening = '1754' OR (SUBSTR(r.kode_rekening, 5, 2) <> '01' AND SUBSTR(r.kode_rekening, 5, 2) <> '02' AND SUBSTR(r.kode_rekening, 5, 2) <> '03' AND SUBSTR(r.kode_rekening, 5, 2) <> '04' AND SUBSTR(r.kode_rekening, 5, 2) <> '05') ) AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal < d.value AND harga_akhir >= d.value THEN harga_akhir
      WHEN (a.id_rekening = '1754' OR (SUBSTR(r.kode_rekening, 5, 2) <> '01' AND SUBSTR(r.kode_rekening, 5, 2) <> '02' AND SUBSTR(r.kode_rekening, 5, 2) <> '03' AND SUBSTR(r.kode_rekening, 5, 2) <> '04' AND SUBSTR(r.kode_rekening, 5, 2) <> '05') ) AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal >= d.value AND harga_akhir >= d.value THEN harga
      ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN (a.id_rekening = '1754' OR (SUBSTR(r.kode_rekening, 5, 2) <> '01' AND SUBSTR(r.kode_rekening, 5, 2) <> '02' AND SUBSTR(r.kode_rekening, 5, 2) <> '03' AND SUBSTR(r.kode_rekening, 5, 2) <> '04' AND SUBSTR(r.kode_rekening, 5, 2) <> '05') ) AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      ...
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN a.id_rekening = '1755' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal < d.value AND harga_akhir >= d.value THEN harga_akhir WHEN a.id_rekening = '1755' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal >= d.value AND harga_akhir >= d.value THEN  harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN a.id_rekening = '1755' AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      ...
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN a.id_rekening = '1756' AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      ...
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN a.id_rekening = '1757' AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      ...
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN a.id_rekening = '1758' AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      ...
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN a.id_rekening = '1759' AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      ...
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN a.id_rekening = '1760' AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      ...
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN a.id_sumber_dana  = '3' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal < d.value AND harga_akhir >= d.value THEN harga_akhir WHEN  a.id_sumber_dana  = '3' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal >= d.value AND harga_akhir >= d.value THEN  harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN a.id_sumber_dana  = '3' AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      END AS kapitalisasi_tt_harga,
      CASE WHEN '".$data['intra_ekstra']."' = '00' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.01' AND status_histori IN ('koreksi_tambah','kapitalisasi') THEN harga ELSE 0 END) 
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.01' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal < d.value AND harga_akhir >= d.value THEN harga_akhir WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.01' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal >= d.value AND harga_akhir >= d.value THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.01' AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      END AS kapitalisasi_bm_a,
      CASE WHEN '".$data['intra_ekstra']."' = '00' THEN SUM(CASE WHEN SUBSTR(r.kode_rekening, 1, 6)   = '5.2.02' AND status_histori IN ('koreksi_tambah','kapitalisasi') THEN harga ELSE 0 END) 
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.02' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal < d.value AND harga_akhir >= d.value THEN harga_akhir WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.02' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal >= d.value AND harga_akhir >= d.value THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.02' AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      END AS kapitalisasi_bm_b,
      CASE WHEN '".$data['intra_ekstra']."' = '00' THEN SUM(CASE WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.03' AND status_histori IN ('koreksi_tambah','kapitalisasi') THEN harga ELSE 0 END) 
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.03' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal < d.value AND harga_akhir >= d.value THEN harga_akhir WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.03' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal >= d.value AND harga_akhir >= d.value THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.03' AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      END AS kapitalisasi_bm_c,
      CASE WHEN '".$data['intra_ekstra']."' = '00' THEN SUM(CASE WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.04' AND status_histori IN ('koreksi_tambah','kapitalisasi') THEN harga ELSE 0 END) 
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.04' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal < d.value AND harga_akhir >= d.value THEN harga_akhir WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.04' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal >= d.value AND harga_akhir >= d.value THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.04' AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      END AS kapitalisasi_bm_d,
      CASE WHEN '".$data['intra_ekstra']."' = '00' THEN SUM(CASE WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.05' AND status_histori IN ('koreksi_tambah','kapitalisasi') THEN harga ELSE 0 END) 
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.05' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal < d.value AND harga_akhir >= d.value THEN harga_akhir WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.05' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal >= d.value AND harga_akhir >= d.value THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN  SUBSTR(r.kode_rekening, 1, 6)   = '5.2.05' AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      ...
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN a.id_sumber_dana  = '1' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal < d.value AND harga_akhir >= d.value THEN harga_akhir WHEN   a.id_sumber_dana  = '1' AND status_histori IN ('koreksi_tambah','kapitalisasi') AND harga_awal >= d.value AND harga_akhir >= d.value THEN harga ELSE 0 END)
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN a.id_sumber_dana  = '1' AND status_histori IN ('kapitalisasi','koreksi_tambah') AND harga_akhir < d.value THEN harga ELSE 0 END)
      ...
      WHEN '".$data['intra_ekstra']."' = '01' THEN SUM(CASE WHEN status_histori = 'mutasi_in' AND a.keterangan = 'proc_reklas_kode' AND harga_awal < d.value AND harga_akhir >= d.value THEN harga_akhir WHEN  status_histori = 'mutasi_in' AND a.keterangan = 'proc_reklas_kode' AND harga_awal >= d.value AND harga_akhir >= d.value THEN harga  ELSE 0 END)
      ...
      WHEN '".$data['intra_ekstra']."' = '02' THEN SUM(CASE WHEN status_histori IN ('koreksi_kurang') AND harga_akhir < d.value  THEN harga ELSE 0 END)
