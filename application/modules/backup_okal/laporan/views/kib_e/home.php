...
<section class="content">
  <h2 style="margin-top:0px">Cetak KIR (KIB E)</h2>
  <form action="<?php echo $action; ?>" method="post" id="form_ususlan" autocomplete="off" target="_blank">
   ...
   <div class="form-group">
      ...
      <select class="form-control" name="id_ruang" id="id_ruang" placeholder="Ruang" data-role="select2">
      ...
      <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#tab_kib_e" data-toggle="tab">KIB E</a></li>
            
          </ul>
          <div class="tab-content">
            
            <div class="tab-pane active" id="tab_kib_e">
              <b>KIB E</b>
    ...
    <a href="<?php echo base_url('laporan/kib_e') ?>" class="btn btn-default">Batalkan</a>
  </form>
