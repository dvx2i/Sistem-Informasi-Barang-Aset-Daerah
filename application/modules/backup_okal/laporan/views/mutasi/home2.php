...
<section class="content">
  <h2 style="margin-top:0px">Laporan Mutasi 2</h2>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" id="form-laporan" action="<?= base_url('laporan/mutasi2/ndownload'); ?>" method="post" target="_blank">
          ...
          <div class="box-body">
            ...
            */ ?>
            ...
            <div class="form-group form-inline">
              <label for="" class="col-sm-2 control-label">Batas Unduhan (kelipatan 5 ribu)</label>
              <div class="col-sm-10">
                <div class="input-group m-t-3">
                  
                  <select name="mulai" id="mulai" class="form-control">
                    <option value="0" selected>1 sampai 5000</option>
                    <option value="5000">5001 sampai 10000</option>
                    <option value="10000">10001 sampai 15000</option>
                    <option value="15000">15001 sampai 20000</option>
                    <option value="20000">20001 sampai 25000</option>
                    <option value="25000">25001 sampai 30000</option>
                  </select>
                </div>
              </div>
            </div>
