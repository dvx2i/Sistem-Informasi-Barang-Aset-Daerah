...
<script type="text/javascript">
  $(document).ready(function() {
    draw_mutasi_c();
    var button = "<input type='button' class='btn btn-success mutasi_c' value='Pilih'>";
    ...
    var t = $("#mytable_kib_c").dataTable({
      initComplete: function() {
        ...
        $('#mytable_kib_c').on('click', '.mutasi_c', function(e) {
      ...
      serverSide: true,
      ajax: {
        "url": base_url + "mutasi/global_mutasi/json_kib_c/list_barang",
        "type": "POST",
        "data": function(data) {
    ...
    $('#temp_kib').on('click', '.mutasi_c', function(e) {
    ...
    function draw_mutasi_c() {
      ...
      $.each(arr_temp, function(index, data) {
        ...
        var button_hapus = "<input type='button' class='btn btn-danger mutasi_c' value='Hapus' attr_id='" + _id + "'>";
        var input_lampiran = '<input class="' + _id + ' hapus_temp_kib_c" type="hidden" name="pengajuan[' + kode_jenis + '][]" value="' + id_kib + '">';
        var tr =
