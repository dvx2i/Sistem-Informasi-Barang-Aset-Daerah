...
<script type="text/javascript">
  $(document).ready(function() {
    draw_mutasi_f();
    var button = "<input type='button' class='btn btn-success mutasi_f' value='Pilih'>";
    ...
    var t = $("#mytable_kib_f").dataTable({
      initComplete: function() {
        ...
        $('#mytable_kib_f').on('click', '.mutasi_f', function(e) {
      ...
      serverSide: true,
      ajax: {
        "url": base_url + "mutasi/global_mutasi/json_kib_f/list_barang",
        "type": "POST",
        "data": function(data) {
    ...
    $('#temp_kib').on('click', '.mutasi_f', function(e) {
    ...
    function draw_mutasi_f() {
      ...
      $.each(arr_temp, function(index, data) {
        ...
        var button_hapus = "<input type='button' class='btn btn-danger mutasi_f' value='Hapus' attr_id='" + _id + "'>";
        var input_lampiran = '<input class="' + _id + ' hapus_temp_kib_f" type="hidden" name="pengajuan[' + kode_jenis + '][]" value="' + id_kib + '">';
        var tr =
