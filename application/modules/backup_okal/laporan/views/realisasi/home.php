...
<section class="content">
  <h2 style="margin-top:0px">Form Kertas Kerja Aset Tetap</h2>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="<?= base_url('laporan/realisasi/ndownload'); ?>" id="form-laporan" method="post" target="_blank">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select class="form-control" name="id_pengguna" id="id_pengguna" data-role="select2">
                  ...
                  <?php endif; ?>
                  <option value="123">RUMAH SAKIT UMUM DAERAH KOTA YOGYAKARTA</option>
                </select>
              </div>
            </div>
            <input type="hidden" name="id_kuasa_pengguna" >
            <?php /*
            <div class="form-group">
            ...
            */ ?>
            ...
            <div class="form-group">
              <label for="" class="col-sm-2 control-label">Jenis Pelaporan </label>
              <div class="col-sm-10" style="padding-top:7px;">
                <label>
                  <input type="radio" name="jenis" id="bln" value="bulan" checked class="flat-red jenis"> Per bulan
                </label>
                <label>
                  <input type="radio" name="jenis" id="semester" value="semester" class="flat-red jenis"> Per semester
                </label>
                <label>
                  <input type="radio" name="jenis" id="thn" value="tahun" class="flat-red jenis"> Per tahun
                </label>
              </div>
            </div>
            ...
            <div class="form-group form-inline"  id="perbulan">
            ...
            <div class="form-group form-inline" style="display: none;" id="pertahun">
              <label for="" class="col-sm-2 control-label">Tahun Transaksi </label>
              
              <div class="col-md-10">
                  <div class="input-group m-t-3">
                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                    <input id="tahun" type="text" class="form-control pull-right tahun_input" name="tahun" placeholder=""  >
                    <?php /*<input id="tahun" type="text" class="form-control pull-right tahun_input" name="tahun" placeholder="" value="<?= $tahun; ?>" required> */ ?>
                  </div>
            ...
            <div class="form-group form-inline" style="display: none;" id="persemester">
              <label for="" class="col-sm-2 control-label">Semester Transaksi </label>
              
              <div class="col-md-10">
                  <select name="semester" id="semester" class="form-control" data-role="select2">
                    <option value="1">Semester 1 (Januari s/d Juni)</option>
                    <option value="2">Semester 2 (Juli s/d Agustus)</option>
                  </select>
                </div>
            </div>

            <!-- <div class="form-group form-inline" >
              <label for="" class="col-sm-2 control-label">Tahap </label>
          ...
          <div class="box-footer">
            ...
            <button type="button" id="unduh" class='btn btn-primary pull-right'> <span class="fa fa-download"></span> Unduh</button>
          </div>
          <!-- /.box-footer -->
        </form>
      </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#bln').on('ifChecked', function (event){
              $('#perbulan').show();
              $('#pertahun').hide();  
              $('#persemester').hide(); 
      });

      $('#bln').on('ifUnchecked', function (event){
              $('#perbulan').hide();
              $('#pertahun').show();
              $('#persemester').hide(); 
      });

      $('#semester').on('ifChecked', function (event){
              $('#perbulan').hide();
              $('#pertahun').hide();
              $('#persemester').show(); 
      });

      $('#semester').on('ifUnchecked', function (event){
        $('#persemester').hide(); 
      });
      
      $('#thn').on('ifChecked', function (event){
              $('#perbulan').hide();
              $('#pertahun').show();  
              $('#persemester').hide(); 
      });

      $('#thn').on('ifUnchecked', function (event){
              $('#pertahun').hide();
      });
  });
</script>