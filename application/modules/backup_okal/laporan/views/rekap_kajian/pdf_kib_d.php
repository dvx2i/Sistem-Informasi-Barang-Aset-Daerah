...
.tg td{font-family:Arial, sans-serif;font-size:12px;padding:2px 6px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-color:black;}
.tg th{font-family:Arial, sans-serif;font-size:12px;font-weight:normal;padding:2px 6px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-color:black;}
...
<table class="tg" style="undefined;table-layout: fixed; width: 1170px">
  <tr>
    <th class="tg-uys7" rowspan="2" style="width: 3%">No. Urt</th>
    <th class="tg-uys7" rowspan="2">Jenis Barang/ Nama Barang</th>
    <th class="tg-uys7" colspan="2">Nomor</th>
    <th class="tg-uys7" rowspan="2">Konstrukdi</th>
    <th class="tg-uys7" rowspan="2">Panjang (Km)</th>
    <th class="tg-uys7" rowspan="2">Lebar (M)</th>
    <th class="tg-uys7" rowspan="2">Luas (M2)</th>
    <th class="tg-uys7" rowspan="2">Letak/ Lokasi</th>
    <th class="tg-uys7" colspan="2">Dokumen</th>
    <th class="tg-uys7" rowspan="2">Status Tanah</th>
    <th class="tg-uys7" rowspan="2">Nomor Kode Tanah</th>
    <th class="tg-uys7" rowspan="2">Asal-usul</th>
    <th class="tg-uys7" rowspan="2">Harga</th>
    <th class="tg-uys7" rowspan="2">Kondisi (B, KB, RB)</th>
