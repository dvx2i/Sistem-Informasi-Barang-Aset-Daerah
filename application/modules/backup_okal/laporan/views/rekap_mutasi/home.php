  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" id="form-laporan" action="<?= base_url('laporan/rekap_mutasi/ndownload'); ?>" method="post" target="_blank">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select class="form-control" name="id_pengguna" id="id_pengguna" data-role="select2">
                  <?php 
				  if ($session->id_role == 1 || $session->id_kode_lokasi == '261') : //261 = pengawas (bisa lihat semua opd meski bukan superadmin) ?> 
                    <option value="">Silahkan Pilih</option>
          ...
          <div class="box-footer">
            ...
            <button style="margin-right: 5px;" type="button" id="unduh_rekon" class='btn btn-success pull-right'><span class="fa fa-download"></span>&nbspUnduh Rekap Mutasi</button>
