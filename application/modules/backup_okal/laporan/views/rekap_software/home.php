...
<section class="content">
  <h2 style="margin-top:0px">Software</h2>
  <!-- right column -->
  <div class="row">
    <div class="col-md-12">
      <!-- Horizontal Form -->
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" id="form-laporan" action="<?= base_url('laporan/rekap_software/excel'); ?>" method="post" target="_blank">
          <div class="box-body">
...
<?php /*
            ...
            <input type="hidden" name="atb" id="atb" value="software">
            <!-- 1.5.03. -->
            <div class="form-group">
