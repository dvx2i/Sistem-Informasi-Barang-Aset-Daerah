...
class Validasi_register_model extends CI_Model
{
  ...
  function json()
  {
    ...
    $this->datatables->add_column('detail', '<a href="' . base_url("mutasi_kir/validasi_register/detail/$1") . '"> <button class="btn btn-info btn-sm" title="Validasi"> <span class="fa fa fa-check-square-o"></span></button></a>', 'encrypt_url(id_mutasi)');
