          ...
          <div class="container separator">
            ...
            <ul class="progress-tracker progress-tracker--text progress-tracker--text-top" style="opacity: 0.9; margin-top: 5px; margin-bottom: 15px;">
              ...
              foreach ($list_status_mutasi as $key => $value) :
                ...
                if ($key < ($id_status_mutasi->status_proses - 1) or ($id_status_mutasi->status_proses == 2)) :        $class =  'is-complete';
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#btn-validasi').on('click', function(e) {
      ...
      // return false;
      // e.preventDefault();
      var link = base_url + 'mutasi_kir/validasi_register/mutasi_action/' + id_mutasi;
      $.ajax({
        url: link,
        type: "POST",
        data: {
...
*/ ?>
      ...
      serverSide: true,
      ajax: {
        "url": base_url + "mutasi_kir/list_data/json_detail/" + id_mutasi,
        "type": "POST"
      },
      columns: [{
          "data": "id_kib",
