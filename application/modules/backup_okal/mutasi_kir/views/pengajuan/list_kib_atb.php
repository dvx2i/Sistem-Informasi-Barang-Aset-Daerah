...
<script type="text/javascript">
  $(document).ready(function() {
    draw_mutasi_atb();
    var button = "<input type='button' class='btn btn-success mutasi_atb' value='Pilih'>";
    ...
    var t = $("#mytable_kib_atb").dataTable({
      initComplete: function() {
        ...
        $('#mytable_kib_atb').on('click', '.mutasi_atb', function(e) {
      ...
      serverSide: true,
      ajax: {
        "url": base_url + "mutasi/global_mutasi/json_kib_atb/list_barang",
        "type": "POST",
        "data": function(data) {
    ...
    $('#temp_kib').on('click', '.mutasi_atb', function(e) {
    ...
    function draw_mutasi_atb() {
      ...
      $.each(arr_temp, function(index, data) {
        ...
        var button_hapus = "<input type='button' class='btn btn-danger mutasi_atb' value='Hapus' attr_id='" + _id + "'>";
        var input_lampiran = '<input class="' + _id + ' hapus_temp_kib_atb" type="hidden" name="pengajuan[' + kode_jenis + '][]" value="' + id_kib + '">';
        var tr =
