...
*/ ?>
      ...
      */ ?>
          ...
          <div class="box-footer">
            ...
            ?>  
            <button id="excel" type="submit" class='btn btn-primary pull-right'><span class="fa fa-file"></span>&nbsp&nbspUnduh</button>&nbsp&nbsp&nbsp&nbsp
            <button id="submit" type="button" name="submit" class='btn btn-primary pull-right'><span class="fa fa-search"></span>&nbsp&nbspCari</button>
...
<script type="text/javascript">
  ...
  $('#excel').on('click', function(e) {
    ...
    var last_bulan_tahun = $('#last_bulan_tahun').val();
    
    var form = "<form id='hidden-form' action='<?= site_url('pencarian/Kib/excel') ?>' method='post'>";

    form += "<input type='hidden' name='kode_jenis' value='" + kode_jenis + "'/>";
    form += "<input type='hidden' name='pemilik' value='" + pemilik + "'/>";
    ...
    form += "<input type='hidden' name='bulan_tahun' value='" + bulan_tahun + "'/>";
    form += "<input type='hidden' name='last_bulan_tahun' value='" + last_bulan_tahun + "'/>";
