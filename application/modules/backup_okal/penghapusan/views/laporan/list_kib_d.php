<table class="table table-bordered table-striped" style="display: none;" id="mytable_kib_d">
  <thead>
    <tr>
      <th width="80px">No</th>
  ...
  $(document).ready(function() {
    ...
    var t = $("#mytable_kib_d").dataTable({
      initComplete: function() {
        ...
        $('#mytable_kib_d').on('click', '.lampiran', function(e) {
      ...
      "info": false,
      ajax: {
        "url": base_url + "penghapusan/global_penghapusan/json_kib_d/laporan",
        "type": "POST",
        "data": function(data) {
    ...
    $('#temp_kib_d').on('click', '.lampiran', function(e) {
    ...
    function draw_lampiran_d() {
      ...
      $.each(arr_temp, function(index, data) {
        ...
        var input_lampiran = '<input class="' + _id + ' hapus_temp_kib_d" type="hidden" name="lampiran[' + id_penghapusan + '][]" value="' + id_penghapusan_barang + '">';
        var tr =
