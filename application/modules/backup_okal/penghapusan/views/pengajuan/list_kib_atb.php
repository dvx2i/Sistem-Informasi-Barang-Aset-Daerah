...
<script type="text/javascript">
  $(document).ready(function() {
    // draw_penghapusan_f();
    var button = "<input type='button' class='btn btn-success pengajuan_atb' value='Pilih'>";

    $(document).on('click', '.flat-red', function() {
      var jenis = $(this).val();
      var mytable_kib_atb = $('#mytable_kib_atb').DataTable();
      mytable_kib_atb.clear().destroy();
      ...
      if (jenis != 'k') {
        ...
        var t = $("#mytable_kib_atb").dataTable({
          initComplete: function() {
            ...
            $('#mytable_kib_atb').on('click', '.pengajuan_atb', function(e) {
          ...
          serverSide: true,
          ajax: {
            "url": base_url + "penghapusan/global_penghapusan/json_kib_atb/list_barang",
            "type": "POST",
            "data": function(data) {
    ...
    $('#temp_kib').on('click', '.pengajuan_atb', function(e) {
    ...
    function draw_penghapusan_f() {
      ...
      $.each(arr_temp, function(index, data) {
        ...
        var button_hapus = "<input type='button' class='btn btn-danger pengajuan_atb' value='Hapus' attr_id='" + _id + "'>";
    ...
    function set_list_id_kib_atb(id_kib_atb) {
      // sessionStorage.removeItem("list_id_kib_atb");
      ...
      // var temp = JSON.parse(sessionStorage.getItem("list_id_kib_atb"));
      // console.log(temp);
