<style media="screen">
  ...
  <section class="content">
    ...
    <form action="<?php echo $action; ?>" method="post" id="form_mutasi">
      ...
      <div class="form-group">
        <label for="varchar">Nama Paket/Keterangan <?php echo form_error('kode_lokasi') ?></label>
        <input type="text" class="form-control" name="nama_paket" id="nama_paket" placeholder="" value="<?php echo $nama_paket; ?>" disabled />
      </div>
      ...
      <button type="button" id="terima_all" class="btn btn-success">Terima Semua</button>
      <button type="button" id="tolak_all" class="btn btn-danger">Tolak Semua</button>
...
$('#terima_all').on('click', function(e){
   $('.radio_terima').iCheck('check');
});
$('#tolak_all').on('click', function(e){
   $('.radio_tolak').iCheck('check');
});
