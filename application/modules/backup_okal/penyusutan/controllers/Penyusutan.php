...
class Penyusutan extends MX_Controller
{
  ...
  public function ndownload()
  {
    ...
    $data['field_name'] = array(
      ...
      'no',  'kode_barang',  'nomor_register',  'nama_barang',  'merk_type', 'tanggal_pembelian', 'umur_bulan', 'umur_ekonomis', 'sisa_umur_ekonomis', 'nilai_perolehan', 'nilai_penyusutan', 'akumulasi_penyusutan', 'nilai_buku', 'instansi',
    ...
    $data['label'] = array(
      ...
      'No',  'Kode Barang',  'Nomor Register',  'Nama Barang / Uraian',  'Merk / Type', 'Tanggal_pembelian/Pengadaan', 'umur_bulan', 'umur_ekonomis', 'Sisa Umur Ekonomis', 'Nilai Perolehan', 'Nilai Penyusutan', 'Akumulasi Penyusutan', 'Nilai Buku', 'Unit Kerja',
    );
  ...
  public function toExcel($data = null)
  {
    ...
    if (in_array('instansi', $data['field_name']))
      $objPHPExcel->setActiveSheetIndex(0)->setCellValue('N' . $counter, 'Unit Kerja');
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('M' . $counter, $t_nilaibuku, PHPExcel_Cell_DataType::TYPE_NUMERIC);
