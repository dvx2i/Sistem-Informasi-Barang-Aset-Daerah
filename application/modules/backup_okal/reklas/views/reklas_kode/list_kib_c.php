...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var t_kib_c = $("#mytable_kib_c").dataTable({
      initComplete: function() {
        ...
        // });
        /*
                $('#mytable_kib_c').on('click', '.mutasi', function(e) {
      ...
      serverSide: true,
      ajax: {
        "url": base_url + "reklas/global_reklas/json_kib_c/list_barang",
        "type": "POST",
        "data": function(data) {
    ...
    /*
        $('#temp_kib_c').on('click', '.mutasi', function(e) {
