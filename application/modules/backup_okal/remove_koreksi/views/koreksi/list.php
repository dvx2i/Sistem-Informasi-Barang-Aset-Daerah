  ...
  <section class="content">
    <div class="row" style="margin-bottom: 10px">
      <div class="col-md-8">
        <h2 style="margin-top:0px">List Pengajuan Kapitalisasi</h2>
      </div>

      <div class="col-md-4 text-right">
        <?php echo anchor(base_url('koreksi/create'), 'Buat', 'class="btn btn-primary"'); ?>
      </div>
    </div>
...
$(document).ready(function() {
  ...
  var t = $("#mytable").dataTable({
    ...
    processing: true,
    serverSide: true,
    ajax: {"url": "koreksi/json_list", "type": "POST"},
    columns: [
      {
