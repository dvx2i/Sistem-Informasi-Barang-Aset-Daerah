...
<section class="content">
  ...
  <form action="<?php echo $action; ?>" method="post" autocomplete="off">
    ...
    <div <?= $id_kib_e == '' ? ' id="input_disable" class="input_disable" ' : ''; ?>>
      ...
      <div class="box" style="padding: 10px; border: 3px solid #d2d6de;">
        ...
        */ ?>
        ...
        <div id='input_disable_barang' class="<?php echo (($validasi == 2) or (!empty($data_reklas))) ? "input_disable" : ""; ?>">
          ...
          <div class="row">
            <div class="col-md-6">
              <a style="margin-bottom: 5px;" class="btn btn-success btn-sm" href="https://aset.jogjakota.go.id/assets/files/ASET_TETAP_LAINNYA.pdf" target="_blank">Referensi Kode Barang</a>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="judul_pencipta" id="judul_pencipta" placeholder="Judul Pencipta" value="<?php echo $judul_pencipta; ?>" />
          </div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="kesenian_asal_daerah" id="kesenian_asal_daerah" placeholder="Kesenian Asal Daerah" value="<?php echo $kesenian_asal_daerah; ?>" />
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label for="varchar">Kesenian(Pencipta) <?php echo form_error('kesenian_pencipta') ?></label>
            <input type="text" class="form-control" name="kesenian_pencipta" id="kesenian_pencipta" placeholder="Kesenian Pencipta" value="<?php echo $kesenian_pencipta; ?>" />
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="kesenian_bahan" id="kesenian_bahan" placeholder="Kesenian Bahan" value="<?php echo $kesenian_bahan; ?>" />
      </div>
      <div class="form-group">
        <label for="varchar">Hewan/Tumbuhan (Jenis) <?php echo form_error('hewan_tumbuhan_jenis') ?></label>
        <input type="text" class="form-control" name="hewan_tumbuhan_jenis" id="hewan_tumbuhan_jenis" placeholder="Hewan Tumbuhan Jenis" value="<?php echo $hewan_tumbuhan_jenis; ?>" />
      </div>
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            <label for="float">Hewan/Tumbuhan (Ukuran) <?php echo form_error('hewan_tumbuhan_ukuran') ?></label>
            <input type="text" class="form-control" name="hewan_tumbuhan_ukuran" id="hewan_tumbuhan_ukuran" placeholder="Hewan Tumbuhan Ukuran" value="<?php echo $hewan_tumbuhan_ukuran; ?>" />
          </div>
        </div>
      ...
      <?php if (empty($data_reklas)) : ?>
        <a href="<?php echo base_url('kib_e') ?>" class="btn btn-default">Batalkan</a>
      <?php else : ?>
