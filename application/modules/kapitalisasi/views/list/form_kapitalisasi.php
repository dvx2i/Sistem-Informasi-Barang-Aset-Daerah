...
<section class="content">
  ...
  <form action="<?php echo $action; ?>" method="post" id="form_ususlan">
    ...
    <div class="nav-tabs-custom">
      ...
      <?php  if($jenis == 'kapitalisasi') : ?>
        <li class="active"><a href="#kapitalisasi" data-toggle="tab">Kapitalisasi</a></li>
        <?php else : ?>
        <li class="active"><a href="#koreksi" data-toggle="tab">Koreksi</a></li>
        <?php endif; ?>
        <!-- <li class="pull-right"><a href="#" class="text-muted"><i class="fa fa-gear"></i></a></li> -->
      </ul>
      <div class="tab-content">

        <div class="tab-pane <?=  $jenis == 'kapitalisasi' ? 'active' : ''; ?> " id="kapitalisasi">
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  <label for="">Nilai Kapitalisasi <?php echo form_error('nilai_kapitalisasi') ?></label>
                  <input readonly type="text" class="form-control" name="nilai_kapitalisasi" id="nilai_kapitalisasi" placeholder="0" value="<?=  $jenis == 'kapitalisasi' ? $nilai_kapitalisasi : ''; ?>" />
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control format_number" name="penambahan_umur_ekonomis" id="penambahan_umur_ekonomis" placeholder="0" value="<?=  $jenis == 'kapitalisasi' ? $umur_ekonomis : ''; ?>" readonly />
              </div>
            </div>
          </div>
        </div>
        <div class="tab-pane <?=  $jenis != 'kapitalisasi' ? 'active' : ''; ?>" id="koreksi">
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                <label for="" style="color:green">Tambah <?php echo form_error('koreksi_tambah') ?></label>
                <input readonly type="text" class="form-control " name="koreksi_tambah" id="koreksi_tambah" placeholder="0" value="<?=  $jenis == 'koreksi_tambah' ? $nilai_kapitalisasi : ''; ?>" />
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input readonly type="text" class="form-control" name="koreksi_kurang" id="koreksi_kurang" placeholder="0" value="<?=  $jenis == 'koreksi_kurang' ? $nilai_kapitalisasi : ''; ?>" />
              </div>
            </div>
            <?php endif; ?>
          </div>
...
<?php if($button != 'Detail') : ?>
    <button type="submit" class="btn btn-primary">Simpan</button>
    <?php endif; ?>
    <a href="<?php echo base_url('kapitalisasi/list_data') ?>" class="btn btn-default">Batalkan</a>
  </form>
...
<script type="text/javascript">
  ...
  $(".date_input").datepicker().on('changeDate', function (e) {
    ...
    $("#nilai_kapitalisasi").keyup(function() {
      ...
      console.log(Number(nilai_perolehan))
