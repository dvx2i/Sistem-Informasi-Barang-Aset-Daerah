...
$(document).ready(function() {
  ...
  var t = $("#mytable_kib_f").dataTable({
    initComplete: function() {
      ...
      $('#mytable_kib_f').on('click','.lampiran', function(e){
    ...
    processing: true,
    serverSide: true,
    ajax: {"url": base_url+"penghapusan/global_penghapusan/json_kib_f/laporan", "type": "POST"},
    columns: [
    {
      "data": "id_kib_f",
      "orderable": false
  ...
  $('#temp_kib_f').on('click','.lampiran', function(e){
  ...
  function draw_lampiran_f(){
    ...
    $.each(arr_temp, function( index, data ) {
      ...
      var input_lampiran = '<input class="'+_id+' hapus_temp_kib_f" type="hidden" name="lampiran['+id_penghapusan+'][]" value="'+id_penghapusan_barang+'">';
      var tr =
