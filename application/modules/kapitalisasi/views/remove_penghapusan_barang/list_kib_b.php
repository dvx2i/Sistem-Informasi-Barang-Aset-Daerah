...
$(document).ready(function() {
  ...
  var t = $("#mytable_kib_b").dataTable({
    initComplete: function() {
      ...
      $('#mytable_kib_b').on('click','.penghapusan', function(e){
        ...
        var arr_kib_b={};
        var temp = JSON.parse(sessionStorage.getItem("penghapusan_kib_b"));
        ...
        sessionStorage.setItem("penghapusan_kib_b", JSON.stringify(arr_kib_b));
        draw_penghapusan_b();
      });
    ...
    processing: true,
    serverSide: true,
    ajax: {"url": base_url+"penghapusan/global_penghapusan/json_kib_b/penghapusan_barang", "type": "POST"},
    columns: [
    {
      "data": "id_kib_b",
      "orderable": false
  ...
  $('#temp_kib_b').on('click','.penghapusan', function(e){
    var attr_id = $(this).attr('attr_id');
    var arr_temp=JSON.parse(sessionStorage.getItem("penghapusan_kib_b"));
    delete arr_temp[attr_id];
    sessionStorage.setItem("penghapusan_kib_b", JSON.stringify(arr_temp));
    draw_penghapusan_b()
  })
  ...
  function draw_penghapusan_b(){
    ...
    $.each(arr_temp, function( index, data ) {
      ...
      var input_penghapusan = '<input class="'+_id+' hapus_temp_kib_b" type="hidden" name="penghapusan['+id_penghapusan+'][]" value="'+id_penghapusan_barang+'">';
      var tr =
