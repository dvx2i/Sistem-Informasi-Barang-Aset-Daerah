...
class Mutasi extends MX_Controller
{
  ...
  public function ndownload()
  {
    ...
    $data['limit'] = 30000;
    $data['offset'] = $this->input->post('mulai');
    ...
    $data['status_histori'] = $this->input->post('status_histori');
    $data['id_sumber_dana'] = $this->input->post('id_sumber_dana') != '' ? $this->input->post('id_sumber_dana') : 0;
    $data['id_rekening'] = $this->input->post('id_rekening') != '' ? $this->input->post('id_rekening') : 0;
...
*/
    ...
    // $data['mutasi'] = array_column($data['mutasi'],null,"tmpid");
    // }
  ...
  public function toExcel($data = null)
  {
    ...
    $index = array(
      ...
      '60000'=> '60001-90000',
      '90000'=> '90001-120000',
      '120000'=> '120001-150000',
      '150000'=> '150001-180000',
      '180000'=> '180001-210000',
      '210000'=> '210001-240000',
      '240000'=> '240001-270000',
      '270000'=> '270001-300000',
      '300000'=> '320001-340000'
    );
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('W' . $counter, 'ID KIB');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('X' . $counter, 'Keterangan');
    ...
    $objPHPExcel->getActiveSheet()->mergeCells('X' . $first_row_header . ':X' . $last_row_header);
    ...
    $objPHPExcel->getActiveSheet()->getStyle("A" . $first_row_header . ":X" . $last_row_header)
      ->applyFromArray($table_header)
      ->getFont()->setSize(12);
      $objPHPExcel->getActiveSheet()->getStyle("A8:X9")
    ...
    foreach ($data['mutasi'] as $key => $value1) :
      ...
      if ($value1['LEVEL'] == 1) :
		...
		*/
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B' . $counter, remove_star($value1['kode_lokasi']) );
		$objPHPExcel->getActiveSheet()->getStyle("B" . $counter . ":" . $last_alpabet . $counter)->applyFromArray(array('font' => array('bold' => true)));
		 $objPHPExcel->setActiveSheetIndex(0)->setCellValue('C' . $counter, '');
		  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('D' . $counter, $value1['instansi']);
		  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E' . $counter, '');
		  ...
		  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I' . $counter, '');
		  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J' . $counter, '');
		  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K' . $counter, '');
		  ...
		  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q' . $counter, '');
		  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('R' . $counter, '');
		  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('S' . $counter, '');
		  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('T' . $counter, '');
		  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('U' . $counter, '');
		  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('V' . $counter, '');
		  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('W' . $counter, '');
		  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('X' . $counter, '');
        ...
        elseif ($value1['status_histori'] == 'entri' or $value1['status_histori'] == 'mutasi_in'  or $value1['status_histori'] == 'koreksi_tambah'   or $value1['status_histori'] == 'kapitalisasi') :
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('W' . $counter, $value1['id_kib']);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('X' . $counter, $value1['ket']);
    ...
    $objPHPExcel->getProperties()->setCreator("Mutasi")
      ->setLastModifiedBy("Mutasi")
      ->setTitle("Export Data Mutasi")
      ->setSubject("Export Mutasi To Excel")
      ->setDescription("Doc for Office 2007 XLSX, generated by PHPExcel.")
      ->setKeywords("office 2007 openxml php")
      ->setCategory("PHPExcel");
    $objPHPExcel->getActiveSheet()->setTitle('Mutasi');
    ...
    header('Content-Disposition: attachment;filename="Laporan Mutasi ' . ucwords($data['nama_lokasi']) . ' ' . $index[$data['offset']] . '.xlsx"');
  ...
  public function toExcelRekon($data = null)
  {
    ...
    $first_row_header = $counter;
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A' . $counter, '');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B' . $counter, 'NOMOR');
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C' . $counter, '');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('D' . $counter, 'SPESIFIKASI BARANG');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H' . $counter, 'Asal/Cara Perolehan Barang');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I' . $counter, 'Tahun Beli/Perolehan');
