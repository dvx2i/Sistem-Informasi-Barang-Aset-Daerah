...
class Mutasi2 extends MX_Controller
{
  ...
  public function index()
  {
    ...
    $data['content'] = $this->load->view('/mutasi/home2', $data, true);
...
*/
    ...
    $data['mutasi'] = $this->mutasi2_model->get_all($data);
  ...
  public function toExcel($data = null)
  {
    ...
    // $mutasi = $this->mutasi2_model->get_all($data);
