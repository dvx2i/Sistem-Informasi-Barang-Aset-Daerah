...
class Rekap_aset extends MX_Controller
{
  function __construct()
  {
    parent::__construct();
    $this->global_model->cek_hak_akses('46');
    $this->load->model('laporan_model');
    $this->load->model('Rekap_aset_model');
  ...
  public function index()
  {
    ...
    $data['content'] = $this->load->view('/rekap_aset/home', $data, true);
  ...
  public function ndownload()
  {
    ...
    $data['start_bulan'] = date('m', tgl_inter("1 " . $this->input->post('bulan_tahun')));
    ...
    $data['mutasi'] = $this->Rekap_aset_model->get_all($data);
  ...
  public function toExcel($data = null)
  {
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B' . $counter, 'NAMA BARANG');
    ...
    foreach ($data['mutasi'] as $key => $value1) :
      ...
      $counter = $counter + 1;
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B' . $counter, $value1['nama_barang']);
