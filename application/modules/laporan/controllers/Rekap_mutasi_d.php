...
class Rekap_mutasi_d extends MX_Controller
{
  function __construct()
  {
    parent::__construct();
    $this->global_model->cek_hak_akses('50');
  ...
  public function index()
  {
    ...
    $data['breadcrumb'] = array(
      ...
      array('label' => 'Rekap Mutasi Jalan,Irigasi dan Jaringan', 'url' => '#', 'icon' => '', 'li_class' => 'active'),
      // array('label' => 'Buat', 'url' => '#','icon'=>'', 'li_class'=>'active'),
    );
    $data['url'] = base_url('laporan/rekap_mutasi_d/ndownload');
