...
class Rekap_mutasi_e extends MX_Controller
{
  function __construct()
  {
    parent::__construct();
    $this->global_model->cek_hak_akses('51');
  ...
  public function index()
  {
    ...
    $data['breadcrumb'] = array(
      ...
      array('label' => 'Rekap Mutasi Aset Tetap Lainnya', 'url' => '#', 'icon' => '', 'li_class' => 'active'),
      // array('label' => 'Buat', 'url' => '#','icon'=>'', 'li_class'=>'active'),
    );
    $data['url'] = base_url('laporan/rekap_mutasi_e/ndownload');
