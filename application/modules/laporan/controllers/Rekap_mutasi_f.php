...
class Rekap_mutasi_f extends MX_Controller
{
  function __construct()
  {
    parent::__construct();
    $this->global_model->cek_hak_akses('52');
  ...
  public function index()
  {
    ...
    $data['breadcrumb'] = array(
      ...
      array('label' => 'Rekap Mutasi Konstruksi Dalam Pengerjaan', 'url' => '#', 'icon' => '', 'li_class' => 'active'),
      // array('label' => 'Buat', 'url' => '#','icon'=>'', 'li_class'=>'active'),
    );
    $data['url'] = base_url('laporan/rekap_mutasi_f/ndownload');
...
*/
  ...
  public function toExcel($data = null)
  {
    ...
    $objPHPExcel->getProperties()->setCreator(strtoupper("ASET"))
      ->setLastModifiedBy("REKAP MUTASI ")
      ->setTitle("Export REKAP MUTASI KIB F")
      ->setSubject("Export REKAP MUTASI To Excel")
      ->setDescription("Doc for Office 2007 XLSX, generated by PHPExcel.")
      ->setKeywords("office 2007 openxml php")
      ->setCategory("PHPExcel");
    $objPHPExcel->getActiveSheet()->setTitle(strtoupper('KIB F'));
    ...
    header('Content-Disposition: attachment;filename="Export REKAP MUTASI KIB F ' . date('Y-m-d') . '.xlsx"');
