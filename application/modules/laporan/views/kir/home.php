...
<section class="content">
  <h2 style="margin-top:0px">Laporan Inventaris</h2>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" id="form-laporan" action="<?= base_url('laporan/kir/excel'); ?>" method="post" target="_blank">
          ...
          <div class="box-body">
            ...
            */ ?>
            ...
            <div class="form-group form-inline">
              <label for="" class="col-sm-2 control-label">No urut Awal (kelipatan 30 ribu,dimulai dari 0)</label>
              <div class="col-sm-10">
                <div class="input-group m-t-3">
                  ...
                  <select name="mulai" id="mulai" class="form-control">
                    ...
                    <option value="150000">150000 sampai 180000</option>
                  </select>
                </div>
              </div>
            </div>
