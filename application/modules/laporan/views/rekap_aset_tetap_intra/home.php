...
<section class="content">
  <h2 style="margin-top:0px">Rekap Aset Tetap Intra</h2>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="<?= base_url('laporan/rekap_aset_tetap_intra/ndownload'); ?>" method="post" target="_blank">
          ...
          <div class="box-body">
            ...
            <input type="hidden" name="id_kuasa_pengguna" id="id_kuasa_pengguna" value="">
            ...
            <input type="hidden" name="intra_ekstra" id="intra_ekstra" value="01">
            <input type="hidden" name="jenis_rekap" id="jenis_rekap" value="objek">
            <!-- <div class="form-group">
