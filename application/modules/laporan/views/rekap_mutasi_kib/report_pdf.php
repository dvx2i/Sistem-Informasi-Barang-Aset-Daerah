...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>REKAPITULASI PENYUSUTAN BARANG</title>
  <style media="screen">
    .header{
      text-align: center;
    }
  ...
  <body>
    ...
    <div class="header">
      <h2>REKAPITULASI PENYUSUTAN BARANG</h2>
      <h3></h3>
    </div>
    <div class="content">
      <br>
      ...
      <table class="fonts-12">
        ...
        <?php foreach ($rekap_penyusutan as $key => $value1) :?>
        <?php
        $tr_font = '';
        ...
        <tr class="<?=$tr_font; ?>">
          <?php foreach ($field_name as $key => $value2) :?>
            <?php
            if (( $value2 == "total_jumlah" or $value2 == "total_harga" or $value2 == "nilai_penyusutan" or $value2 == "akumulasi_penyusutan" or $value2 == "nilai_buku") and (is_numeric($value1[$value2]) ) ) :  ?>
