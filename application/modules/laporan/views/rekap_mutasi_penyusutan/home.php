...
<section class="content">
  <h2 style="margin-top:0px">Laporan Rekap Mutasi Penyusutan</h2>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="<?= base_url('laporan/rekap_mutasi_penyusutan/ndownload'); ?>" method="post" target="_blank">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <select class="form-control" name="kode_jenis" id="kode_jenis" data-role="select2">
                  <option value="">Silahkan Pilih</option>
