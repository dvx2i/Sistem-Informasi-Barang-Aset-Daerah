...
<section class="content">
  <h2 style="margin-top:0px">Tanah Kekancingan</h2>
  <!-- right column -->
  <div class="row">
    <div class="col-md-12">
      <!-- Horizontal Form -->
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" id="form-laporan" action="<?= base_url('laporan/tanah_lainnya/excel'); ?>" method="post" target="_blank">
          <div class="box-body">
