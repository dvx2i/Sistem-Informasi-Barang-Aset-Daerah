...
<section class="content">
  ...
  <h2 style="margin-top:0px">Detail Mutasi</h2>
  <div class="row">
    <div class="col-md-12">
  ...
  <form action="<?php echo $action; ?>" method="post" id="form_mutasi" autocomplete="off">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
          <label for="date">Tanggal Validasi<?php echo form_error('tanggal_validasi') ?></label>
          <input type="text" class="form-control date_input" name="tanggal_validasi" id="tanggal_validasi" placeholder="Tanggal Validasi" value="<?php echo $tanggal_validasi; ?>" />
        </div>
      </div>
    </div>
        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="tab-pane <?= $kib_active[0] == '1' ? 'active' : ''; ?>" id="tab_kib_a">
              <b>KIB A</b>
              <?php $this->load->view('list_data/list_kib_a'); ?>
            </div>
            ...
            <div class="tab-pane <?= $kib_active[0] == '3' ? 'active' : ''; ?>" id="tab_kib_c">
              <b>KIB C</b>
              <?php $this->load->view('list_data/list_kib_c'); ?>
            </div>
            <div class="tab-pane <?= $kib_active[0] == '4' ? 'active' : ''; ?>" id="tab_kib_d">
              <b>KIB D</b>
              <?php $this->load->view('list_data/list_kib_d'); ?>
            </div>
            ...
            <?php /*
              <div class="tab-pane <?= $kib_active[0]=='6'?'active':''; ?>" id="tab_kib_f">
                <b>KIB F</b>
                <?php $this->load->view('list_data/list_kib_f'); ?>
              </div>
*/ ?>
            <div class="tab-pane <?= $kib_active[0] == '5.03' ? 'active' : ''; ?>" id="tab_kib_atb">
              <b>KIB ATB</b>
              <?php $this->load->view('list_data/list_kib_atb'); ?>
            </div>
            <!-- /.tab-pane -->
          </div>
          <!-- /.tab-content -->
    ...
    <a href="<?php echo base_url('mutasi/list_data') ?>" class="btn btn-default">Batalkan</a>
  </form>
