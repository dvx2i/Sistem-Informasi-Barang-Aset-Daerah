...
<script type="text/javascript">
  $(document).ready(function() {
    draw_mutasi_b();
    var button = "<input type='button' class='btn btn-success mutasi_b' value='Pilih'>";
    ...
    var t = $("#mytable_kib_b").dataTable({
      initComplete: function() {
        ...
        $('#mytable_kib_b').on('click', '.mutasi_b', function(e) {
      ...
      serverSide: true,
      ajax: {
        "url": base_url + "mutasi/global_mutasi/json_kib_b/list_barang",
        "type": "POST",
        "data": function(data) {
    ...
    $('#temp_kib').on('click', '.mutasi_b', function(e) {
    ...
    function draw_mutasi_b() {
      ...
      $.each(arr_temp, function(index, data) {
        ...
        var button_hapus = "<input type='button' class='btn btn-danger mutasi_b' value='Hapus' attr_id='" + _id + "'>";
        var input_lampiran = '<input class="' + _id + ' hapus_temp_kib_b" type="hidden" name="pengajuan[' + kode_jenis + '][]" value="' + id_kib + '">';
        var tr =
          ...
          "<td>" + data['nomor_pabrik'] + ", " + data['nomor_rangka'] + ", " + data['nomor_mesin'] + ", " + data['nomor_polisi'] + ", " + data['nomor_bpkb'] + "</td>" +
          "<td>" + data['bahan'] + "</td>" +
          "<td>" + data['asal_usul'] + data['tahun_pembelian'] + "</td>" +
