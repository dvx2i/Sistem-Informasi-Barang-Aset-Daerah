...
<div class="row">
  ...
  <form action="<?php echo $action; ?>" method="post" id="form_mutasi" autocomplete="off">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
          ...
          <input type="text" id="tanggal_bast" name="tanggal_bast" value="<?= $tanggal_bast ? tgl_indo($tanggal_bast) : ''; ?>" class="form-control date_input" placeholder="Tanggal BAST" disabled>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
          ...
          <input type="text" name="nomor_bast" value="<?= $nomor_bast; ?>" class="form-control" placeholder="Nomor BAST" disabled>
        </div>
      </div>
    </div>
    <div class="row" style="margin-bottom:10px;">
      <div class="col-md-12">
        ...
        <br>
          <label for="varchar"><small>Format BAST PDF/Image (JPG,JPEG,PNG)</small></label>
      </div>
    </div>
  ...
  <input type="hidden" name="id_mutasi" value="<?php echo $id_mutasi; ?>" />
  <input type="file" name="file" id="upload-picture" class="hide" accept="image/*,application/pdf" size="20">
