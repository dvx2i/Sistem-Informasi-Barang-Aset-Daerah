              ...
              <div class="row" style="margin-bottom:10px;">
                <div class="col-md-12">
                  <?php foreach ($mutasi_picture as $key => $value) : ?>
                    ...
                    <?php if(substr($value->url, -3) != 'pdf') : ?>
                      <a id="single_image" href="<?php echo base_url() . $value->url; ?>" target="_blank">
                        <img src="<?php echo base_url() . $value->url; ?>" alt="" style="height: 180px;width: 150px; border:2px solid;" />
                      </a>
                      <?php else : ?>
                        <a href="<?php echo base_url() . $value->url; ?>" target="_blank">
                        <img src="<?php echo base_url('assets/files/mutasi/pdf.png'); ?>" alt="" style="height: 180px;width: 150px; border:2px solid;" />
                      </a>
                      <?php endif; ?>
                    </div>
                  <?php endforeach; ?>
...
*/ ?>
      ...
      serverSide: true,
      ajax: {
        "url": base_url + "mutasi/validasi_register/json_detail/" + id_mutasi,
        "type": "POST"
      },
      columns: [{
          "data": "id_kib",
