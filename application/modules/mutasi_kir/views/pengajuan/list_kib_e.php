  ...
  $('#id_ruang_asal').change(function(e){
    var t = $("#mytable_kib_e").dataTable({
      ...
      initComplete: function() {
        ...
        $('#mytable_kib_e').on('click', '.mutasi_e', function(e) {
      ...
      serverSide: true,
      ajax: {
        "url": base_url + "mutasi_kir/kib_e/json",
        "type": "POST",
        "data": function(data) {
    ...
    $('#temp_kib').on('click', '.mutasi_e', function(e) {
    ...
    function draw_mutasi_e() {
      ...
      $.each(arr_temp, function(index, data) {
        ...
        var button_hapus = "<input type='button' class='btn btn-danger mutasi_e' value='Hapus' attr_id='" + _id + "'>";
        var input_lampiran = '<input class="' + _id + ' hapus_temp_kib_e" type="hidden" name="pengajuan[' + kode_jenis + '][]" value="' + id_kib + '">';
        var tr =
