...
$(document).ready(function() {
  ...
  var t = $("#mytable_kib_e").dataTable({
    initComplete: function() {
      ...
      $('#mytable_kib_e').on('click','.penghapusan', function(e){
        ...
        var arr_kib_e={};
        var temp = JSON.parse(sessionStorage.getItem("penghapusan_kib_e"));
        ...
        sessionStorage.setItem("penghapusan_kib_e", JSON.stringify(arr_kib_e));
        draw_penghapusan_e();
      });
    ...
    processing: true,
    serverSide: true,
    ajax: {"url": base_url+"penghapusan/global_penghapusan/json_kib_e/penghapusan_barang", "type": "POST"},
    columns: [
    {
      "data": "id_kib_e",
      "orderable": false
  ...
  $('#temp_kib_e').on('click','.penghapusan', function(e){
    var attr_id = $(this).attr('attr_id');
    var arr_temp=JSON.parse(sessionStorage.getItem("penghapusan_kib_e"));
    delete arr_temp[attr_id];
    sessionStorage.setItem("penghapusan_kib_e", JSON.stringify(arr_temp));
    draw_penghapusan_e()
  })
  ...
  function draw_penghapusan_e(){
    ...
    $.each(arr_temp, function( index, data ) {
      ...
      var input_penghapusan = '<input class="'+_id+' hapus_temp_kib_e" type="hidden" name="penghapusan['+id_penghapusan+'][]" value="'+id_penghapusan_barang+'">';
      var tr =
