...
class Validasi_reklas_kode_model extends CI_Model
{
  ...
  function json()
  {
    ...
    $this->datatables->select("
      ...
      , CONCAT_WS(' - ',C.kode_barang, CASE WHEN ((C.kode_sub_sub_rincian_objek='000') or (C.kode_sub_sub_rincian_objek='0')) THEN C.nama_barang ELSE C.nama_barang_simbada END, CONCAT('(id kib : ', id_kib_tujuan,')') ) nama_barang_tujuan_with_id
    ");
