      ...
      <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab_kib_lainnya">
              <b>ASET LAIN-LAIN</b>
            </div>
 ...
 */ ?>
  $(document).on('change', '#kode_jenis', function() {
    ...
    $.ajax({
      ...
      url: "<?php echo site_url("reklas/reklas_kode/get_list_kib"); ?>",
      data: {
    ...
    $("#loadMe").modal("hide");
        if (kode_jenis == "01") {
          ...
          $('#tab_kib_atb').html(data);
        } else if (kode_jenis == "5.04") {
          $("#tab_kib_lainnya").addClass('active');
          // $("#mytable_kib_lainnya").DataTable().ajax.reload();
          $('#tab_kib_lainnya').html(data);
        }
