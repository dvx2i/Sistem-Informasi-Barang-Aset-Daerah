...
$(document).ready(function() {
  ...
  var t = $("#mytable_kib_c").dataTable({
    initComplete: function() {
      ...
      $('#mytable_kib_c').on('click','.koreksi', function(e){
    ...
    processing: true,
    serverSide: true,
    ajax: {"url": base_url+"penghapusan/global_penghapusan/json_kib_c/list_barang", "type": "POST"},
    columns: [
    {
      "data": "id_kib_c",
      "orderable": false
  ...
  $('#temp_kib_c').on('click','.koreksi', function(e){
