...
<section class="content">
  ...
  <form action="<?php echo $action; ?>" method="post">
    ...
    <div <?= $id_kib_f == '' ? ' id="input_disable" class="input_disable" ' : ''; ?>>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select class="form-control" name="referensi_id" id="referensi_id" data-role="select2">
                <option value="">Silahkan Pilih</option>
      ...
      <div class="box" style="padding: 10px; border: 3px solid #d2d6de;">
        ...
        <div id='input_disable_barang' class="<?php echo (($validasi == 2) or (!empty($data_reklas))) ? "input_disable" : ""; ?>">
          ...
          <div class="row">
            <div class="col-md-6">
              <a style="margin-bottom: 5px;" class="btn btn-success btn-sm" href="https://aset.jogjakota.go.id/assets/files/KONSTRUKSI_DALAM_PENGERJAAN.pdf" target="_blank">Referensi Kode Barang</a>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <select class="form-control" name="kontruksi_bertingkat" id="kontruksi_bertingkat">
              <option value="">Silahkan Pilih</option>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <select class="form-control" name="kontruksi_beton" id="kontruksi_beton">
              <option value="">Silahkan Pilih</option>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="lokasi_alamat" id="lokasi_alamat" placeholder="Lokasi Alamat" value="<?php echo $lokasi_alamat; ?>" />
      </div>
      <div class="row">
        <div class="col-md-2">
          <div class="form-group">
            <label for="date">Tanggal Dokumen  (SPK/IMB/Kontrak) <?php echo form_error('dokumen_tanggal') ?></label>
            <input type="text" class="form-control date_input" name="dokumen_tanggal" id="dokumen_tanggal" placeholder="Dokumen Tanggal" value="<?php echo $dokumen_tanggal; ?>" />
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="col-md-2">
          <div class="form-group">
            ...
            <input type="text" class="form-control date_input" name="tanggal_mulai" id="tanggal_mulai" placeholder="Tanggal Mulai" value="<?php echo $tanggal_mulai; ?>" />
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control format_float" name="nilai_kontrak" id="harga" placeholder="Nilai Kontrak" value="<?php echo str_replace(".", ",", $nilai_kontrak); ?>" <?php echo $validasi == 2 ? "readonly" : ""; ?> />
          </div>
        </div>
      </div>
      ...
      <?php if (empty($data_reklas)) : ?>
        <a href="<?php echo base_url('kib_f') ?>" class="btn btn-default">Batalkan</a>
      <?php else : ?>
