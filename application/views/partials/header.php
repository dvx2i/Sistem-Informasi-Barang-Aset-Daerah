<header class="main-header">
  ...
  <a href="<?php echo base_url(); ?>" class="logo">
    ...
    <span class="logo-lg"><b>Admin </b>ASET V2</span>
  </a>
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown notifications-menu hidden">
          ...
          <ul class="dropdown-menu">
            <li class="header">Anda mempunyai 10 notifikasi</li>
            <li>
              <!-- inner menu: contains the actual data -->
              <ul class="menu">
                <li class="">
                  <a href="#">
                    <i class="fa fa-clock-o text-orange"></i> KIB A (5 permintaan validasi)
                  </a>
                </li>
        ...
        <li>
          <!-- <button type="button" name="button" class="btn btn-success">Set Location</button> -->
          <?php
          if (getRole(array('Super Admin'))) : ?>
            <a href="<?= base_url('location'); ?>" class="">
              <span style="font-weight:bold;" class="fa fa-location-arrow"> Pilih Lokasi</span>
            </a>
          <?php
          endif; ?>
        ...
        <li class="user user-menu ">
          <a href="https://simulasi-aset.jogjakota.go.id" class="btn btn-success">
            Demo
          </a>
        </li>
        <li class="dropdown user user-menu ">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="hidden-xs"><?= $this->session->userdata('session')->role ?></span>
          </a>
          <ul class="dropdown-menu">
            <!-- User image -->
        ...
        <li class="hide">
          <a href="#" data-toggle="control-sidebar" class=""><i class="fa fa-gears"></i></a>
        </li>
        <li>
          <a href="#"></a>
        </li>
